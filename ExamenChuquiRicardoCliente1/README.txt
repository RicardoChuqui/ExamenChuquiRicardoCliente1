...
a persistence unit "ExamenChuquiRicardoCliente1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenChuquiRicardoCliente1\pom.xml":
...
artifact ("ExamenChuquiRicardoCliente1.war") is already built. You can build
